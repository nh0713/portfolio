            ...
            <div>
                ...
                <Container fluid className="outerContainer">
                    <Container className='projectDetails'>
                        ...
                        <h2>My Role</h2>
                        <p>For this project, I was responsible for the sneaker release list screen and the sneaker details screen. One of our stretch goals, that was not completed due to time restrictions, was the functionality to allow users to vote on specific shoes. In the shoe details page, there are two buttons. One with a fire icon and one with a trash icon. The intention behind this functionality was to allow users to vote and see which shoes would be popular. </p>
